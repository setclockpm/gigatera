...
Template Name: Case Studies: Area Flood
    ...
    <main id="main" class="site-main" role="main">
          ...
          <div id="lighting-nav-container" class="col-sm-7">
            <nav id="lighting-nav" class="section-nav">
              <ul class="nav nav-pills">
                ...
                <li role="presentation" data-section="area-flood" class="<?php echo(get_post_meta($post->ID, 'lighting-category', true) == 'area-flood' ? 'active' : 'off'); ?>">
                  <a href="/case-studies/sports-flood">Area Flood</a>
                </li>
      ...
      <div class="inner-content row">
        ...
        <?php while ( have_posts() ) : the_post(); ?>
          <?php get_template_part( 'template-parts/content', 'area-flood-projects' ); ?>
