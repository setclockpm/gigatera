...
Template Name: Roadway Lighting Projects
...
?>
	...
	<div id="primary" class="lighting">
      ...
      <div class="applications-title-container background-roadway">
        <div class="applications-title page">
          <header class="entry-header">
            <h1 id="applications-entry-title" class="entry-title">Roadway Lighting Projects</h1>
          </header>
        </div>
      </div>
        ...
        <nav id="applied-projects" class="navbar navbar-fixed-top section-nav">
          <ul class="nav nav-pills">
  	  	...
  	  	<?php while ( have_posts() ) : the_post(); ?>
  	  		...
  	  		<?php get_template_part( 'template-parts/content', 'roadway-projects' ); ?>
