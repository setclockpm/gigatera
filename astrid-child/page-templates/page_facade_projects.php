...
Template Name: Facade Lighting Projects
...
?>
	...
	<div id="primary" class="lighting">
      ...
      <div class="applications-title-container background-facade">
        <div class="applications-title page">
          <header class="entry-header">
            <h1 id="applications-entry-title" class="entry-title" style="color:#fff;">
        ...
        <nav id="applied-projects" class="navbar navbar-fixed-top section-nav">
          <ul class="nav nav-pills">
            ...
            <li role="presentation" data-section="Sports / Flood Lighting Projects">
              <a href="/applications/sports-flood-lighting">
  	  	...
  	  	<?php while ( have_posts() ) : the_post(); ?>
  	  		...
  	  		<?php get_template_part( 'template-parts/content', 'facade-projects' ); ?>
