<?php
/**
 * The template for displaying the control systems footer.
 *
...
<script type="text/javascript">
    jQuery(document).ready(function($){
      ...
      $('.control-systems-menu-container > ul.nav li a').click(function(e) {
          ...
          $("h1#control-systems-entry-title").text(clickedLink.parent().data("section"));
      });
