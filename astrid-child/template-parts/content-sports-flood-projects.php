...
<!--
  ...
  <div class="middle col-md-4 col-sm-6 col-xs-12">
    ...
    <div id="dongung-palace" class="col-xs-12 card">
      <div class="card-block">
        <div class="thumbnail-top">
          <iframe width="280" src="https://www.youtube.com/embed/mV8IOiap2W0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
          <h3 class="title">GyeongJu Anapji Pond</h3>
        </div>
        ...
        <div class="card-text bottom">
          <p class="description">
            MAHA / SUFA 400W, Kyeongju Donggung Palace and Wolji, Reference Video, Korea
          </p>
        </div>
      </div>
      <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
    ...
    <div id="military-academy" class="col-xs-12 card">
      <div class="card-block">
        <div class="thumbnail-top">
          <iframe width="280" src="https://www.youtube.com/embed/8P9JSXQMy0I" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
          <h3 class="title">Military Academy Korea</h3>
        </div>
        <div class="horizontal-divider">
          <hr class="card-divider">
        </div>
        <div class="card-text bottom">
          <p class="description">
            MAHA 400W, Indoor Tennis Court Reference Video, Korea
          </p>
        </div>
      </div>
      <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
    ...
    <div id="suwon-world-cup-stadium" class="col-xs-12 card">
      <div class="card-block">
        <div class="thumbnail-top">
          <iframe width="280" src="https://www.youtube.com/embed/imPxOJhN_kE" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          <h3 class="title">Suwon World Cup Stadium</h3>
        </div>
        <div class="horizontal-divider">
          <hr class="card-divider">
        </div>
        <div class="card-text bottom">
          <p class="description">
            SUFA-A 1.2kW, Suwon World Cup Stadium Reference Video, Korea
          </p>
        </div>
      </div>
      <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
...
<!-- 
  <div class="right col-md-4 col-sm-6 col-xs-12">
      ...
      <div class="card-block">
        <div class="card-top">
          <div class="case-study-links">
            <a class="thumbnail" href="/applications/sports-flood-lighting/tennis-courts-middle-school">
            <img src="https://gigaterausa.com/wp-content/uploads/2018/01/dongnae-tennis-cst.png">
          </a>
          <a class="case-study" href="/applications/sports-flood-lighting/tennis-courts-middle-school">
            Case Study
          </a>
          </div>
          
          <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
          <h3 class="title">Dongnae Middle School</h3>
        </div>
        <div class="horizontal-divider">
          <hr class="card-divider">
        </div>
        <div class="card-text bottom">
          <p class="description">
            Light Source: MAHA-NEO 600 <br>  
            Tennis Courts (Middle School)<br>
          </p>
        </div>
    ...
    <div id="sajik-stadium" class="col-xs-12 card">
      <div class="card-block">
        <div class="thumbnail-top">
          <iframe width="280" src="https://www.youtube.com/embed/XF9wHvaIQRc" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
          <h3 class="title">Busan Sajik Stadium</h3>
        </div>
        <div class="horizontal-divider">
          <hr class="card-divider">
        </div>
        <div class="card-text bottom">
          <p class="description">
            SUFA-A 1.2kW / 600W, MAHA-RGB, Busan Sajik Baseball Stadium, Korea
          </p>
        </div>
      </div>
      <img class="card-img-bottom" src="https://gigaterausa.com/wp-content/uploads/2018/01/giga-divider.jpg" alt="Card Bottom Border">
    ...
    <div id="residential-area" class="col-xs-12 card case-study">
      <div class="card-block">
        <div class="thumbnail-top">
          <a class="thumbnail" href="/applications/sports-flood-lighting/residential-area">
            <img src="https://gigaterausa.com/wp-content/uploads/2018/01/residential-area-cst.png">
          </a>
          <h3 class="title">South African Residential Area</h3>
        </div>
        <div class="horizontal-divider">
          <hr class="card-divider">
        </div>
        <div class="card-text bottom">
          <p class="description">
            Light Source: MAHA 400 <br>  
            Rural Residential Area<br>
          </p>
        </div>
        <div class="btn-container">
          <a class="case-study" href="/applications/sports-flood-lighting/residential-area">
            Case Study >>
          </a>
        </div>
      </div>
